...
Trial sequence (timings):
    ...
    3. Up/down arrow cue (center)       300 ms   (imagery only)
    4. Blank imagery period            3000 ms   (imagery)
       Cued image, fullscreen          3000 ms   (perception)
...
T_CUE            = 300    # up/down arrow cue in center of screen (imagery mode only)
...
def run_trial_sequence(win, tracker, trial_num, trial_def,
    ...
    # -- 3. Up/down arrow cue in center of screen (300 ms) -- imagery only -----
    if mode != 'perception':
