"""
multi_stim_perception.py -- Perception task

Run this as its own session, entirely separate from multi_stim_imagery.py
...
Design:
    ...
    task (one face render and one house render, back to back), in a
    ...
    Perception: 16 trials, run in a single block (no breaks).
